import { countOfAllBooleansAndStrings } from "./countOfAllBooleansAndStrings";
...
describe("the countOfAllBooleansAndStrings(arr) function", function () {
  ...
  it("should return a value that indicates the total amount of boolean and string values in the input array", function () {
    ...
    expect(
      submittedSolution,
      "the output does not reflect an accurate amount of boolean and string values"
    ).to.equal(5);
  });
